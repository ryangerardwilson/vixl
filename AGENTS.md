...
- `main.py`: CLI entrypoint (`help`, `version`, `upgrade`, `config`, `open`), file/bootstrap setup, curses startup.
...
- Show help/version: `python main.py help` / `python main.py version`
- Run upgrade path logic: `python main.py upgrade`
